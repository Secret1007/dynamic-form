            ...
            <Form v-else label-align="left" layout="vertical">
                ...
                <div v-for="item of advanceFormItemProps" :key="item.name">
                    ...
                    >
                        <component
                            ...
                            :is="item.component"
                            v-model:value="
                                formConfig.currentItem.itemProps[item.name]
                            "
                        />
                    </FormItem>
                </div>
                ...
                >
                    ...
                    <Input
                        ...
                        v-model:value="
                            formConfig.currentItem.itemProps['message']
                        "
                        placeholder="请输入必选提示"
                    />
                </FormItem>
                <FormItem
                    ...
                    :class="{
                        'form-rule-props':
                            !!formConfig.currentItem.itemProps['rules'],
                    }"
                >
                    <!-- <RuleProps /> -->
                </FormItem>
...
} from "./vForm/config/formItemPropsConfig";
